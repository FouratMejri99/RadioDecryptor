...
export default function Home() {
  ...
  const [currentPage, setCurrentPage] = useState<
    "home" | "presets" | "bookmarks" | "settings"
  >("home");
  ...
  const handleBroadcastFrequency = (frequency: any) => {
    ...
    setTimeout(() => {
      console.log(
        `Now broadcasting ${frequency.name} at ${frequency.frequency.toFixed(
          3
        )} MHz`
      );
    }, 500);
          ...
          <>
            ...
            <div className="px-4 pb-4">
              <div className="bg-card rounded-lg p-4 border border-border">
                ...
                <Button
                  onClick={() =>
                    handleSettingsChange({ isScanning: !isScanning })
                  }
                  className={`w-full ${
                    isScanning
            ...
            <DecryptionPanel
              ...
              onManualDecrypt={() => {
                ...
                console.log(
                  "Decryption completed for frequency:",
            ...
            <LiveBroadcasting
              ...
              onUpdateTitle={(title) =>
                handleSettingsChange({ broadcastTitle: title })
              }
            />
          </>
        )}
